...
CALL insDNS('A4567', 'b www.example.com', 1, 1);

CALL insSSDP('A7899', '239.255.255.250.1900', '1900', 'ssdp:all', 'ssdp:discover', 2);

CALL insReceived('A1234', 20, 'NTP', '2021-10-10', '08:00:00', '172.16.0.9', '186.15.2.10', 40, 2);

CALL insDrafts('B33ZX', '2021-10-10', '07:45:55', '172.16.0.9', '186.15.2.10', 'f4:d1:08:0f:84:12', 'c4:e9:0a:54:be:01', 'IPv4', 4, 'None', '0x0', 'None', 1, '', 0, 64, 'udp', 'None', '1.2.3.4', '1.2.3.4', 'None', 'domain', 'domain', 'None', 'ntp');
CALL insDrafts('B44ZX', '2021-10-10', '07:45:55', '172.16.0.9', '186.15.2.10', 'f4:d1:08:0f:84:12', 'c4:e9:0a:54:be:01', 'IPv4', 4, 'None', '0x0', 'None', 1, '', 0, 64, 'udp', 'None', '1.2.3.4', '1.2.3.4', 'None', 'domain', 'domain', 'None', 'dns');
CALL insDrafts('B55ZX', '2021-10-10', '07:45:55', '172.16.0.9', '186.15.2.10', 'f4:d1:08:0f:84:12', 'c4:e9:0a:54:be:01', 'IPv4', 4, 'None', '0x0', 'None', 1, '', 0, 64, 'udp', 'None', '1.2.3.4', '1.2.3.4', 'None', 'domain', 'domain', 'None', 'ssdp');

CALL insNTP2('B33ZX', 61, 4, 'client', 2, 10, 0, 0, 0, '127.0.0.1', 0, '01:15:25', '02:25:35', '03:35:45', '04:45:55');

CALL insDNS2('B44ZX', 'b www.example.com', 1, 1);

CALL insSSDP2('B55ZX', '239.255.255.250.1900', '1900', 'ssdp:all', 'ssdp:discover', 2);
